...
class BarangMasukController extends Controller
{
    public function index()
    {
        ...
        return view('main.admin.barang-masuk.index', compact('barang_masuks'), $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('main.admin.barang-masuk.create', compact('barang', 'idTransaksi'), $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($barangmasuk->save()) {
            ...
            return redirect()->route('admin.barang-masuk.index')->with('pesan', 'Barang masuk berhasil ditambahkan dan stok diperbarui.');
        } else {
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.barang-masuk.index')->with('pesan', 'Data barang masuk berhasil dihapus dan stok diperbarui.');
    }
}
