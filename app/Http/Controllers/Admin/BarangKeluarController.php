...
class BarangKeluarController extends Controller
{
    public function index()
    {
        ...
        return view('main.admin.barang-keluar.index', compact('barang_keluars'), $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('main.admin.barang-keluar.create', compact('barang', 'idTransaksi'), $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($barangKeluar->save()) {
            ...
            return redirect()->route('admin.barang-keluar.index')->with('pesan', 'Barang keluar berhasil ditambahkan dan stok diperbarui.');
        } else {
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.barang-keluar.index')->with('pesan', 'Data barang keluar berhasil dihapus dan stok diperbarui.');
    }
