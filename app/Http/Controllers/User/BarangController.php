...
class BarangController extends Controller
{
    ...
    {
        $barangs = Barang::all();
        return view('main.user.barang.index', [
            "barangs" => $barangs,
    ...
    {
        return view('main.user.barang.create', [
            'title' => 'Tambah Data',
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($barang->save()) {
            ...
            return redirect()->route('user.barang.index')->with('pesan', 'Data berhasil disimpan.');
        } else {
    ...
    public function edit($id)
    {
        ...
        return view('main.user.barang.edit', [
            'barang' => $barang,
            'title' => 'Laman Edit'
        ]);
    }
    public function update(Request $request, $id)
    {
        ...
        // Redirect ke halaman barang dengan pesan sukses
        return redirect()->route('user.barang.index')->with('pesan', 'Data berhasil diubah.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('user.barang.index')->with('pesan', 'Kategori berhasil dihapus.');
    }
}
