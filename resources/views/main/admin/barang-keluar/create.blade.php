...
@section('content')
    <div class="container-fluid">
        <h1 class="h4 mb-4 text-gray-800"><i class="fas fa-clipboard-list fa-fw mr-2"></i>Barang Keluar</h1>

        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold">Entri Data Barang Keluar</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.barang-keluar.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-md-7">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                <label>Tujuan Barang<span class="text-danger">*</span></label>
                                <input type="text" name="destination" class="form-control text-uppercase"
                    ...
                    <div class="form-group pt-3">
                        ...
                        <a href="{{ route('admin.barang-keluar.index') }}" class="btn btn-secondary pl-4 pr-4">Batal</a>
                    </div>
                </form>
            </div>
        </div>
